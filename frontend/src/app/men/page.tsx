...
export default function MenCollection() {
    ...
    // Filter out only men's products (mock logic for now using existing data)
    const menProducts = products.filter(p => p.category.toLowerCase().includes('men') || p.category.toLowerCase().includes('running') || p.category.toLowerCase().includes('sneaker'));
            ...
            <div className="bg-[#f9f9f9] border-b border-gray-100">
                <div className="max-w-7xl mx-auto px-6 md:px-12 py-12 relative overflow-hidden">
                    <div className="relative z-10 space-y-4">
                        <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Home / Men</p>
                        <h1 className="text-4xl md:text-5xl font-black uppercase tracking-tighter text-black">MEN'S COLLECTION</h1>
                        <p className="text-sm font-medium text-gray-600 max-w-sm">Premium footwear engineered for every step. Discover our latest arrivals and timeless classics.</p>
                    </div>
                    {/* Decorative Background Image (Placeholder) */}
                    <div className="absolute right-0 top-0 bottom-0 w-1/2 opacity-20 pointer-events-none">
                        <img src="https://images.unsplash.com/photo-1552346154-21d32810baa3?auto=format&fit=crop&q=80&w=800" className="w-full h-full object-cover object-right" alt="Men's Lifestyle" />
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 py-12 flex flex-col md:flex-row gap-12">
                ...
                <aside className="w-full md:w-64 flex-shrink-0 space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                            {['Sneakers (120)', 'Running (80)', 'Casual Shoes (35)', 'Loafers (40)', 'Boots (25)'].map((cat, i) => (
                ...
                <div className="flex-1 space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <p className="text-xs font-medium text-gray-500">Showing 1-12 of 250+ products</p>
                    ...
                    <div className="flex items-center justify-center gap-2 pt-12">
                        ...
                        <button className="w-8 h-8 rounded flex items-center justify-center text-xs font-bold text-gray-500 hover:bg-gray-100">21</button>
                    </div>
                </div>
            </div>
